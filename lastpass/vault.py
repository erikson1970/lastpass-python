...
class Vault(object):
    ...
    def readblob_local(cls,newusername,passwordIn,filename='LPBlob.bin'):
        ...
        decoded=parser.decode_aes256_cbc_base64(innerdecoded[17:],mydecodingkey)
    ...
    def writeblob_local(cls,myblob,username,password,filename='LPBlob.bin'):
        ...
        innerencoded="#%16d%s"%(myblob.key_iteration_count,parser.encode_aes256_cbc_base64(myblob.bytes,mykey,myiv))
        myiv="\x00"+parser.urandom(14)+"\x00"
